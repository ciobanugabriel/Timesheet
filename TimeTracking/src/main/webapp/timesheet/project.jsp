...
<fmt:bundle basename="Timesheet">
    ...
    <div class="bg-dark my-5 w-50 d-flex justify-content-center text-warning p-3"
        ...
        <form action="project" method="post">
            <div class="m-auto"><h1 class="text-center"><fmt:message key="project"/></h1></div>
        ...
        <form id="projectForm" action="project" method="post"></form>
    </div>
        ...
        <c:forEach items="${requestScope.projects}" var="project">
            <tr>
                ...
                <td class="text-right">
                    ...
                    <button type="submit" form="projectForm" class="btn btn-outline-danger btn-sm mx-2" value="delete"
                            name="button"
...
<script>
    ...
    function deleteFunction(id) {
        ...
        element.setAttribute("name", "projectID");
